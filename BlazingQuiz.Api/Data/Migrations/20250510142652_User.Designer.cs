            ...
            modelBuilder.Entity("BlazingQuiz.Api.Data.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            IsApproved = true,
                            Name = "Andrey",
                            PasswordHash = "AQAAAAIAAYagAAAAENol+yMgvN+++qOOnQ8szUJWEjGXMEfRmIbciBNQrCBY/xygB0UVeLcrw6DHMgTNvQ==",
                            Phone = "89777441323",
                            Role = "Admin"
                        });
                });
            ...
            modelBuilder.Entity("BlazingQuiz.Api.Data.Entities.StudentQuizQuestion", b =>
                {
                    ...
                    b.HasOne("BlazingQuiz.Api.Data.Entities.User", null)
                        .WithMany("StudentQuizQuestion")
